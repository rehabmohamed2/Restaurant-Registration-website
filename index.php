...
<html lang="en">
  ...
  <nav>
    <ul class="nav-flex-row">
      ...
      <li class="nav-item">
        <a href="http://localhost/server/reserve.php">Reservation</a>
      </li>
      <li class="nav-item">
        <a href="menu.html">Menu</a>
      </li>
      <li class="nav-item">
        <a href="ass1.html">Log In</a>
      </li>
    </ul>
  </nav>
  ...
  <section class="section-intro">
    ...
    <div class="link-to-book-wrapper">
      <a class="link-to-book" href="table.html">Book a table</a>
    </div>
  </section>
  ...
  <section class="about-section">
    <article>
      <h3>
          HIGH QUALITY
          We carefully select the dishes with the best and freshest ingredients that you will love
      </h3>
  ...
  <div class="container">
    <div class="row-flex">
      ...
      <div class="contact-adress">
        ...
        <p>
          <span>010 9283 8456</span>
          <span>Talaat Harb Street</span>
          <span>Downtown</span>
        </p>
      </div>
    </div>
